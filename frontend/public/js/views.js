//EJS Compiled Views - This file was automatically generated on Fri Dec 16 2022 17:23:30 GMT+0100 (Ora standard dell’Europa centrale)
...
;
var __line = 1
  , __lines = "\n<form id='filter_form' action=\"/filter\">\n\n    <div class=\"range-slider\">\n        <label for=\"range-slider__range\"> Price </label><br>\n        <input id='range_price' type=\"number\" name=\"range-slider__range\" step=\"10\" min=\"0\" max=\"10000\">\n        <!-- <input id='range_price' type=\"range\" class=\"range-slider__range\" step=\"100\" value=\"0\" min=\"0\" max=\"10000\" oninput=\"this.nextElementSibling.value = this.value\"> -->\n        <!-- <output>0</output> -->\n    </div>\n\n    <section id='checklist'>\n        <div>\n            <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"checkbox\" id=\"IL\" name=\"IL\" value=\"IL\">\n            <label for=\"IL\"> IL</label>\n        </div>\n\n        <div>\n            <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"checkbox\" id=\"IN\" name=\"IN\" value=\"IN\">\n            <label for=\"IN\"> IN</label>\n        </div>\n\n        <div>\n            <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"checkbox\" id=\"MI\" name=\"MI\" value=\"MI\">\n            <label for=\"MI\"> MI</label>\n        </div>\n        <!-- <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"submit\" value=\"Submit\"> -->\n        <!-- <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"checkbox\" id=\"city1\" name=\"city1\" value=\"Bike\">\n        <label for=\"city1\"> city1</label><br>\n        <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"checkbox\" id=\"city2\" name=\"city2\" value=\"Car\">\n        <label for=\"city2\"> city2</label><br>\n        <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"checkbox\" id=\"city3\" name=\"city3\" value=\"Boat\">\n        <label for=\"city3\"> city3</label><br> -->\n        <!-- <input class=\"checkoption\"  onclick=\"checkedOnClick(this);\" type=\"submit\" value=\"Submit\"> -->\n    </section>\n    <section id=\"quantity\">\n        <label for=\"quantity\"> Beds</label><br>\n        <input id='beds_quantity' type=\"number\" name=\"quantity\" min=\"1\" max=\"10\">\n    </section>\n\n    <section id=\"cities_select\">\n        <label for=\"cities\">Choose city</label>\n        <select name=\"cities\" id=\"cities\">\n\n            <% for (var i = 0; i < cities.length-1; i=i+2) { %>\n                <option value=\"<%= cities[i] %>\"><%= cities[i] %> (<%= cities[i+1] %>)</option>\n            <% } %>\n<!-- \n            <option value=\"Chicago\">Chicago</option>\n            <option value=\"Willow Springs\">Willow Springs</option>\n            <option value=\"Naperville\">Naperville</option>\n            <option value=\"Lisle\">Lisle</option> -->\n        </select>\n    </section>\n\n    <button id=\"filter_button\" class=\"searchButt\" data-action=\"search\" type=\"submit\">Filter</button>\n</form>"
  , __filename = undefined;
try {
  var __output = "";
  function __append(s) { if (s !== undefined && s !== null) __output += s }
  with (locals || {}) {
    ...
    ; __append("\n                <option value=\"")
    ; __line = 45
    ; __append(escapeFn( cities[i] ))
    ; __append("\">")
    ; __append(escapeFn( cities[i] ))
    ; __append(" (")
    ; __append(escapeFn( cities[i+1] ))
    ; __append(")</option>\n            ")
    ; __line = 46
    ;  } 
    ; __append("\n<!-- \n            <option value=\"Chicago\">Chicago</option>\n            <option value=\"Willow Springs\">Willow Springs</option>\n            <option value=\"Naperville\">Naperville</option>\n            <option value=\"Lisle\">Lisle</option> -->\n        </select>\n    </section>\n\n    <button id=\"filter_button\" class=\"searchButt\" data-action=\"search\" type=\"submit\">Filter</button>\n</form>")
