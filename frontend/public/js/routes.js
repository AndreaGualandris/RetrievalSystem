...
// try {
//     let query_results = fs.readJSONSync(path.resolve("../Spiders/apfinder.com/out.json"));
//     // high_scores = json_HS.high_scores;
//     // console.log("json correctly loaded" , high_scores);
// } catch (e) {
//     console.error(e)
